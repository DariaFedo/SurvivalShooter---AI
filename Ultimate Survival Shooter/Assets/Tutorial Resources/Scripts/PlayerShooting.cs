...
public class PlayerShooting : MonoBehaviour
{
    ...
    void Awake()
    {
        // Create a layer mask for the Shootable layer. so get only bunnies that can be shoot
    ...
    void Update()
    {
        ...
        // If the Fire1 button is being press and it's time to fire...left mouse button from unity by default
